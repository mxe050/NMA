...
$scopedCss = @"
/* ===== NMAの基本タブ 専用スタイル ===== */
.nma2-wrap { display:flex; gap:0; min-height:600px; }
.nma2-sidebar {
  width:280px; min-width:220px; background:#fff; border-right:1px solid #d5dbdb;
...
.nma2-main { flex:1; padding:25px 35px; max-width:900px; overflow-x:hidden; }
...
.nma2-wrap .formula { background:#f4f6f7; border:1px solid #d5dbdb; padding:15px; margin:15px 0; text-align:center; font-family:'Cambria Math',serif; font-size:1.1em; border-radius:4px; }
.nma2-wrap .ref { background:#fef9e7; border-left:4px solid #f39c12; padding:10px 15px; margin:12px 0; font-size:0.88em; border-radius:0 4px 4px 0; }
.nma2-wrap .ref strong { color:#e67e22; }
.nma2-wrap .note { background:#eaf2f8; border-left:4px solid #3498db; padding:12px 15px; margin:12px 0; border-radius:0 4px 4px 0; }
.nma2-wrap .warning-box { background:#fdedec; border-left:4px solid #e74c3c; padding:12px 15px; margin:12px 0; border-radius:0 4px 4px 0; }
.nma2-wrap .card { background:#fff; border:1px solid #d5dbdb; border-radius:8px; padding:20px; margin:15px 0; box-shadow:0 2px 5px rgba(0,0,0,.05); }
.nma2-wrap .card h4 { color:#1a5276; margin-bottom:10px; }
.nma2-wrap table { width:100%; border-collapse:collapse; margin:15px 0; font-size:0.9em; }
.nma2-wrap th,
...
@media (max-width:900px) {
  ...
  .nma2-sidebar { width:100%; position:static; max-height:none; }
  .nma2-main { padding:15px; }
}
"@
